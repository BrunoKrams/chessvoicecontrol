...
from test_data_generation.model.moves import simple_bishop_move_with_file_and_target
from test_data_generation.model.moves.simple_bishop_move_with_file_and_target import SimpleBishopMoveWithFileAndTarget
